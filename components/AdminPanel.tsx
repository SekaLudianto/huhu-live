...
const AdminPanel: React.FC<AdminPanelProps> = ({ isOpen, onClose, actions, moderators, owners, addModerator, removeModerator, bannedWords }) => {
    ...
    return (
        ...
        >
            <div 
                className="bg-gray-800 border border-cyan-500/30 rounded-lg shadow-2xl w-full max-w-sm text-white"
                onClick={(e) => e.stopPropagation()}
            >
                <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-xl font-bold flex items-center gap-2">
                            <AdminIcon className="w-6 h-6 text-cyan-400" />
                            Panel Kontrol Admin
                        </h2>
                    ...
                    <div className="space-y-4">
                                ...
                                <div className="space-y-2 pt-2">
                                    ...
                                    <div className="flex gap-2">
                                        <input
                                            ...
                                            maxLength={5}
                                            className="flex-grow w-full bg-gray-700 text-white placeholder-gray-400 border border-gray-600 rounded-lg px-3 py-2 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 outline-none uppercase"
                        ...
                        {activeTab === 'mods' && (
                            <div className="space-y-3">
                                <div className="space-y-2">
                                    <label htmlFor="modUsernameInput" className="block text-sm font-medium text-gray-300">
                                        Tambah Moderator:
                                    </label>
                                    <div className="flex gap-2">
                                        <input
                                            ...
                                            onKeyPress={handleKeyPress}
                                            className="flex-grow w-full bg-gray-700 text-white placeholder-gray-400 border border-gray-600 rounded-lg px-3 py-2 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 outline-none"
                                ...
                                <div className="max-h-40 overflow-y-auto pr-2 space-y-2">
                                    <h4 className="text-sm font-semibold text-gray-400 mt-2">Daftar Moderator:</h4>
                                    {[...moderators].map(mod => (
                                        <div key={mod} className="flex items-center justify-between bg-gray-700 p-2 rounded-md">
                        ...
                        {activeTab === 'filter' && (
                            <div className="space-y-2">
                                <h4 className="text-sm font-semibold text-gray-400">Kata yang difilter (via `!skip`):</h4>
                                <div className="bg-gray-700 p-3 rounded-md max-h-48 overflow-y-auto">
                                    {bannedWords.size > 0 ? (
                                        ...
                                        <p className="text-sm text-gray-400">Belum ada kata yang difilter.</p>
                                    )}
                                </div>
                            </div>
                        )}
                ...
                <div className="bg-gray-900 px-6 py-2 rounded-b-lg">
