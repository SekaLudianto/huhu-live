...
export const SocialIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962A3 3 0 0115 9.75v.75c0 .414.336.75.75.75h.75a3 3 0 013 3v.375c0 .621-.504 1.125-1.125 1.125H15m-3.75-2.25A3 3 0 019.75 15v-.75c0-.414-.336-.75-.75-.75h-.75a3 3 0 01-3-3V9.75c0-.621.504-1.125 1.125-1.125h1.5c.621 0 1.125.504 1.125 1.125v3.75m-3.75 0h-1.5a3 3 0 01-3-3V9.75c0-.621.504-1.125 1.125-1.125h1.5c.621 0 1.125.504 1.125 1.125v3.75" />
    </svg>
);